...
export function blockUser(http: HttpClient, rootUrl: string, params: BlockUser$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseVoid>> {
...
blockUser.PATH = '/api/v1/users/block';
